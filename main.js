    ...
    methods: {
        ...
        add() {
            ...
            if (this.input != "") { //evito di aggiungere valori vuoti
                ...
                let oggetto = {setting: false, date: dayjs().format("DD/MM/YYYY HH:mm:ss"), text: this.input, status: 'sent'};
                ...
                setTimeout(function() {
                    ...
                    let risposta = {setting: false, date: dayjs().format("DD/MM/YYYY HH:mm:ss"), text: 'ok', status: 'received'};

                    that.contacts[that.attivo].messages.push(risposta);

                }, 1000);

                //Soluzione con arrow function cosi' this si riferisce allo scope del padre
                /* setTimeout(() => {

                    let risposta = {setting: false, date: '10/01/2020 15:30:56', text: 'ok', status: 'received'};

                    this.contacts[this.attivo].messages.push(risposta);
